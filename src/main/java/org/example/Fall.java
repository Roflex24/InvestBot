...
public class Fall {
    ...
    private String url = "https://smart-lab.ru/q/shares/order_by_last_to_month_price/asc/?val_middle_gt=10000000&capitalization_gt=100000000000";

    public void getUrl() {
        try (FileWriter writer = new FileWriter("src//main//resources//Fall.html", false)) {
            // запись всей строки
    ...
    public String getAll() {
        try {
            File file = new File("src//main//resources//Fall.html");
